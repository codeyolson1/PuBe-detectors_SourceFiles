...
#ifndef G4PSVolumeSurfaceCurrent_h
#define G4PSVolumeSurfaceCurrent_h 1
...
class G4PSVolumeSurfaceCurrent : public G4VPrimitivePlotter
{
 public:  // with description
  G4PSVolumeSurfaceCurrent(G4String name, G4int direction, G4int depth = 0);
  G4PSVolumeSurfaceCurrent(G4String name, G4int direction, const G4String& unit,
                         G4int depth = 0);
  virtual ~G4PSVolumeSurfaceCurrent();
